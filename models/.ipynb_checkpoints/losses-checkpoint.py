...
"""Change by zzy (begin)"""
# import models.Cobi.fuctional as FCobi
import models.CoBi as CobiL
"""Change by zzy (end)"""
...
class CoBiLoss:
    def __init__(self, use_vgg_=True, vgg_layer_='relu5_4'):
        super(CoBiLoss, self).__init__()
        self.criterions = CobiL.ContextualBilateralLoss(use_vgg=use_vgg_, vgg_layer=vgg_layer_)

    def forward(self, x, y):
        loss = self.criterions(x, y)
        return loss
