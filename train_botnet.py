...
from engine import Engine, Engine_botnet
...
eval_dataset_real = datasets.CEILTestDataset(
    join(datadir, 'real_eval'),
    fns=read_fns('real_eval.txt'))
...
while engine.epoch < 30:
    ...
    if engine.epoch == 23:
        ...
        train_dataset.fusion_ratios = ratio
        set_learning_rate(5e-5)
    if engine.epoch == 25:
        set_learning_rate(1e-5)
